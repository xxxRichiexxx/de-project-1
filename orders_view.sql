-- Изменяем представление analysis.orders таким образом, чтобы исчезнувшее поле status бралось из новой, связанной таблицы production.orderstatuslog в источнике.
